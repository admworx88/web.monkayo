      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            {branding.logos.footer ? (
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl shadow-sm" style={{ backgroundImage: `linear-gradient(to bottom right, ${branding.colors.primary}, ${branding.colors.primary})` }}>
                  <Building2 className="h-6 w-6 text-white" />
                </div>
                <div>
                  <h3 className="text-white font-bold text-base">LGU Monkayo</h3>
                  <p className="text-xs text-stone-400">Davao de Oro</p>
                </div>
              </div>
            )}
            <p className="text-sm text-stone-400 leading-relaxed">
              Serving the people of Monkayo with transparency, efficiency, and dedication to progress.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm">
                <MapPin className="h-4 w-4 mt-0.5 shrink-0" style={{ color: branding.colors.accent }} />
                <span className="text-stone-400">
                  Municipal Hall, Monkayo, Davao de Oro
                </span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Phone className="h-4 w-4 shrink-0" style={{ color: branding.colors.accent }} />
                <span className="text-stone-400">(084) 123-4567</span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Mail className="h-4 w-4 shrink-0" style={{ color: branding.colors.accent }} />
                <span className="text-stone-400">info@monkayo.gov.ph</span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Facebook className="h-4 w-4 shrink-0" style={{ color: branding.colors.accent }} />
                <a
        ...
        <div className="border-t border-stone-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-stone-500 text-center sm:text-left">
            © {new Date().getFullYear()} Local Government Unit of Monkayo. All rights reserved.
          </p>
